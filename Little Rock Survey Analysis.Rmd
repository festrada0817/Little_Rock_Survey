...
Survey respondents were asked what is the signle biggets challenge preventing them from access to affordable housing.
...
describe_you_plot_data <- survey_data %>%
  ...
  mutate(
    ...
    describe_raw = ifelse(is.na(describe_raw) | describe_raw == "", "No response", describe_raw)
  ) %>%
